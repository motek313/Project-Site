...
let cropArray = [
    ...
    {cropName: 'broccoli', sproutImage: 'images/sprout.png', cropImage: 'images/broccoli.png', rotten: 'images/rotten.png', minHarvest: (1000*60*60*24*4), maxHarvest: (1000*60*60*24*20), cost: 12, yieldRate: .4},
    {cropName: 'romaine', sproutImage: 'images/romaine-sprout.png', cropImage: 'images/romaine.jpg', rotten: 'images/rotten.png', minHarvest: (1000*60*60*24*1), maxHarvest: (1000*60*60*24*5), cost: 4, yieldRate: .6}
    ];
